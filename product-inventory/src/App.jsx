...
//     try {
//       const response = await axios.post("http://127.0.0.1:8000/products/upload-excel", formData);
//       setProducts(response.data);
//     } catch (error) {
//       console.error(error);
//       alert(error.response?.data?.detail?.error || "Upload failed");
//     }
//   };
...
//     { name: 'Name', selector: row => row['Product Name'], sortable: true, grow: 6 }, // more space for long names
